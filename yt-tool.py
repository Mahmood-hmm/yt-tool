...
if check () :
    ...
    if platform.system().lower() == "windows" :
        ...
        if auto.lower() in ["yes" , "y" , ""] :
            ...
            if platform.system().lower() == "widnows" :
                pass
            else :
...
def choices () :
    ...
    Console.print ("[yellow] |1| [/yellow] Download a video")
    Console.print ("[yellow] |2| [/yellow] Download a playlist")
    Console.print ("[yellow] |3| [/yellow] Download a sound from video")
    Console.print ("[yellow] |4| [/yellow] Help")
    Console.print ("[yellow] |5| [/yellow] Exit")
...
while True :
    ...
    if choice == "1" : 
        ...
        table.add_row("use ald version of yt-dlp or ffmpeg" , "youtube every weak make patches make sure to download latest version")
        Console.print (table)
        Console.input("[red]Enter to continue[/red]")
